...
DATABASES = {
    'default': {
        ...
        'NAME': 'djangodb',      # Your MySQL database name
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'heritagebagumire250@gmail.com' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['heritierbagumire367@gmail.com'] # email on which you will receive messages sent from website
